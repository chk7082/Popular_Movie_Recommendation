<template>
  <div class="total-carousel-container">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <h1 class="carousel-explanation ms-5 mb-2">인기 Top 100 영화</h1>
    ...
    <!-- Modal start -->
    <MovieModal v-if="showModal" class="movie-modal" :selected="selected" @close-modal="closeModal"/>  
    <!-- Modal end -->
  </div>
</template>
...
export default {
  ...
  methods: {
    getMovies() {
      const getMovieURL = `${this.$store.state.api_url}/api/v1/top_100_movie_list/`
